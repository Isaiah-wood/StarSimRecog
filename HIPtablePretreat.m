...
HIPTablePath = [workspacePath, '/StarLib/hip_table.dat'];
starsTable = readtable(HIPTablePath,"NumHeaderLines",9,"VariableNamingRule","preserve");
...
writematrix(StarsLib, [workspacePath, '/StarLib/hip_table.csv']);
